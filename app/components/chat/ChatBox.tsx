  ...
  return (
    <div
      className={classNames(
        'relative bg-[#fafafa]  p-3 rounded-[25px]   relative w-full max-w-chat mx-auto z-prompt',
    ...
    >
      ...
      <div
        className={classNames('relative  border-bolt-elements-borderColor bg-[#fafafa] backdrop-blur rounded-[25px] p-1')}
      >
        <textarea
