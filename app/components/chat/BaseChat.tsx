...
export const BaseChat = React.forwardRef<HTMLDivElement, BaseChatProps>(
  (
    ...
    // Dans BaseChat.tsx
const [isPushToGitHubDialogOpen, setIsPushToGitHubDialogOpen] = useState(false);
          ...
          <div className={classNames(styles.Chat, 'flex flex-col flex-grow lg:min-w-[var(--chat-min-width)] h-full')}>
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                <h1 className="text-8xl font-medium tracking-tight text-balance text-black ">Your dreaming app. Build in minutes.</h1>
              </div>
            )}
              ...
              >
                ...
                <div
                  className={classNames(
                    'relative  p-3 rounded-lg  relative w-full max-w-chat mx-auto z-prompt',
                ...
                >
                  ...
                  <div
                    className={classNames(
                      'relative  border-bolt-elements-borderColor bg-[#fafafa] backdrop-blur rounded-[25px] p-1',
                    )}
                  >
                    <textarea
                      ref={textareaRef}
...
function ScrollToBottom() {
  ...
  return (
    !isAtBottom && (
      <button
        className="absolute z-50 top-[0%] translate-y-[-100%] text-4xl rounded-lg left-[50%] translate-x-[-50%] px-1.5 py-0.5 flex items-center gap-2 bg-white shadow-sm border border-bolt-elements-borderColor text-bolt-elements-textPrimary text-sm"
